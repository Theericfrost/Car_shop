...
router.post('/filter', async (req,res)=> {
    try{
        ...
        if (weightLift == "moreThan5000" ) {
            ...
            .select('title description price weightLift bucketCapacity')
            fotons = await FRONT.find({brand: 'fotonlovol'}).where('weightLift').gt(5000)
            .select('title description price weightLift bucketCapacity')
            ...
            .select('title description price weightLift bucketCapacity')
            fotons = await FRONT.find({brand: 'fotonlovol'}).where('weightLift').lte(weightLift).gt(3000)
            .select('title description price weightLift bucketCapacity')
            ...
            .select('title description price weightLift bucketCapacity')
            fotons = await FRONT.find({brand: 'fotonlovol'}).where('weightLift').lte(weightLift)
            .select('title description price weightLift bucketCapacity')
...
router.get('/', async (req,res)=>{
    try{
        ...
        .select('title description price weightLift bucketCapacity')
        const fotons = await FRONT.find({brand: 'fotonlovol'})
        .select('title description price weightLift bucketCapacity')
